...
real_peaks_file = dir + "/real_peaks.txt"
noise_peaks_file = dir + "/noise_peaks.txt"
...
height_index = 4
fig_title = "Intensity of Real peaks vs noise peaks of filtered peaks using one AA tag"
fig_file = dir + "/fig/intensity.real.vs.noise_peaks of filtered peaks using one AA tag.svg"
...
height_index = 1
fig_title = "Supporting number of Real peaks vs noise peaks of one scan"
fig_file = dir + "/fig/supporting_num.1.real.vs.noise_peaks.svg"
